...
function initializeMap() {
    ...
    coordsDiv.innerHTML = `
        <small class="text-muted">
            ...
            Lat: <strong id="live-lat">39.0000</strong> |
            Lng: <strong id="live-lng">35.0000</strong>
        </small>
    `;
...
async function fetchEarthquakeData() {
    ...
    try {
        ...
        document.getElementById('earthquakes-tbody').innerHTML =
            '<tr><td colspan="7" class="text-center text-danger">Failed to load earthquake data. Please try again later.</td></tr>';
    }
}
    ...
    displayData.forEach(eq => {
        ...
        const popupContent = `
            <div style="min-width: 200px;">
                <h4 style="margin-bottom: 0.5rem; color: #2c3e50;">Magnitude ${eq.magnitude.toFixed(1)}</h4>
...
function populateTable() {
    ...
    if (sortedEarthquakes.length === 0) {
        tbody.innerHTML = '<tr><td colspan="7" class="text-center">No earthquakes found for the selected filters.</td></tr>';
        return;
    }
